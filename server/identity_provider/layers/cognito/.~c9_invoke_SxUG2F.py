...
class CognitoIdentityProviderManagement(IdentityProviderInterface):
     ...
     def create_siloed_idp(self, event):
        ...
        response = {"userPoolId": user_pool_id, "appClientId": app_client_id}
     ...
     def create_operational_idp(self, event):
        ...
        create_tenant_admin_response = user_management_layer.create_operational_admin(user_pool_id, admin_user_name, user_details)
