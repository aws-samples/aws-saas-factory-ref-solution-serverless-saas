...
# for a pooled deployment, the PLATINUM_TIER_API_KEY env var WILL NOT be defined
...
standard_tier_api_key = os.environ.get('STANDARD_TIER_API_KEY', '')
...
def lambda_handler(event, context):
    ...
    # "arn:aws:iam::{}:role/authorizer-access-role".format(
    #     aws_account_id)
